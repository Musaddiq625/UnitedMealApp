            ...
            child: Column(children: [
              ...
              Padding(
                ...
                child: Column(children: [
                  ...
                  SizedBox(height: 30),
                  for (int i = 0; i < 2; i++)
                    CartItem(i + 1, TempData.tempFoodItems[i]['food']),
                  SizedBox(height: 12),
                  Row(children: [
                    SizedBox(width: 20),
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(children: [
                      Padding(
                          ...
                          child: cartItemBox('10 PC', TempData.tempFoodItems[0]['food'])),
                      cartItemBox('10 PC', TempData.tempFoodItems [0]['food']),
                    ]),
                  )
                ]),
              ),
              ...
              Padding(
                ...
                child: ButtonWidgetRound('continue'
                    .toString()
                    .tr,
