...
class Constants{
  ...
  static const Color GREEN_COLOR = Color(0XFF004C1B);
  static const Color TEXT_WHITE_COLOR = Colors.white;
  static const Color TEXT_BG_COLOR = Color(0XFFEBFBFA); //light blueish


  static const double APP_HORIZONTAL_WIDTH = 15.0;
  static const String DISTANCE_UNIT = 'ft';
}